...
axes.text(x = (charge_time/2-0.8), y = volt_max/2, s = ("Время заряда: " + str(round(charge_time, 2)) + " c"), color = 'blue', fontsize = 14)
axes.text(x = (charge_time+discharge_time/2-0.8), y = volt_max/2, s = ("Время разряда: " + str(round(discharge_time, 2)) + " c"), color = 'red', fontsize = 14)
